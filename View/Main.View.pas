...
begin
  ToastAlert('Informação', 'Texto informativo....', taInfo);
end;
...
begin
  ToastAlert('Atenção', 'Ação ou opção inválida...', taWarning);
end;

procedure TMainView.pnl_successClick(Sender: TObject);
begin
  ToastAlert('Sucesso', 'Operação concluída com sucesso', taSuccess);
end;
